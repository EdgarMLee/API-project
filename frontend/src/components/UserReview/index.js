...
function ReviewUser({review}) {
  ...
  return (
    <div className='reviewBox'>
      ...
      <div className='reviewName'>Anonymous User</div>
      <div className='reviewDate'>{date.toString()}</div>
      <div className='reviewReview'>{review?.review}</div>
      </div>
      <div className='reviewDivDelete'>
        {currentUser && (
          <div className='reviewDelete'>
            <button onClick={handleDelete} className='reviewDeleteButton'>Delete</button>
          </div>
        )}
      </div>
    </div>
